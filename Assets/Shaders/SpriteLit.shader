...
////// Emissive:
                ...
                float3 node_2226 = (_LightColor0.rgb*attenuation*((_MainTex_var.rgb*_Color.rgb*i.vertexColor.rgb)*node_603));
                float3 emissive = node_2226;
